# Scope: Forge Implementation Track
...
|---|------|-------|-------------|--------|
| 2 | Core Rendering & Effects Pipeline | Fix bugs with uploading multiple images, adding all 4 effect types, grid layouts, custom overlays without layer corruption, and isolating RNG seeds for rendering stages. | None | PLANNED |
